...
- 设置页面描述（SEO：seach engine optimization搜索引擎优化）：`<meta name="Description" content="描述的内容">`

- 定义关键词（告诉搜索引擎，这个网页是干嘛的，能够提高搜索引擎命中率，让别人能够找到你，搜索到你）：`<meta name="Keywords" content="关键词1，关键词2......">`
...
- alt：alt是英语“alternate”替代的意思，就表示不管什么原因，当这个图片无法被显示的时候，出现的替代文字（有的浏览器不支持）
...
- 相对路径：就是每次都从.html文件所在的文件夹开始查找（项目用）
